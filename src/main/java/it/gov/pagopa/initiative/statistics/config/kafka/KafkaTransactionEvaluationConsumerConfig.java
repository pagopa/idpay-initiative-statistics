...
public class KafkaTransactionEvaluationConsumerConfig extends BaseKafkaConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, String> kafkaTransactionEvaluationListenerContainerFactory(ConsumerFactory<String, String> consumerFactory, KafkaProperties defaultKafkaProperties) {
